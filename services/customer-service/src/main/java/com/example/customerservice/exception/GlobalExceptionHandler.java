...
public class GlobalExceptionHandler {
  ...
  public ResponseEntity<ApiResponse<Void>> handleCustomerNotFound(CustomerNotFoundException exception) {
    return ResponseEntity.status(NOT_FOUND).body(ApiResponse.error(exception.getMessage()));
  }

  @ExceptionHandler(EmailExistedException.class)
  public ResponseEntity<ApiResponse<Void>> handleEmailExisted(EmailExistedException exception) {
    return ResponseEntity.status(CONFLICT).body(ApiResponse.error(exception.getMessage()));
  }
